         ...
         <div class="row" style="margin:10px;">
          ...
          <li class="active"><a href="echeque.jsp?x=<%=session.getAttribute("acct_number").toString()%>">Echeque</a></li>
           ...
           <li class="active"><a href="Contact.jsp?x=<%=session.getAttribute("acct_number").toString()%>">Contact Us</a></li>
            ...
            <h3>At Worldwide Bank, we are committed to provide best internet banking services to our customers. Please feel free to share your Internet Banking experience with us over phone.
SBI now provides your Account Balance and Transaction details over phone round the clock.</h3>
        
        <h4><b>Phone</b> :1800 11 2211 & 1800 425 3800 (Toll free and accessible from all landlines and mobile phones)</h4>
    	
    	<h4><b>Email</b>: worldwide.banking123@gmail.com</h4>
