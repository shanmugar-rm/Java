...
<%! @SuppressWarnings("unchecked") %>
    <div class="container-fluid ">
      ...
      <div class="headerStyle">
        ...
        <div class="panel-group" style="texta-align:center">
  				<div class="panel panel-primary">
   				<div class="panel-heading"><strong>Deposit E-Cheque</strong></div>
  			
    			<div class="panel-body">
				<form action="depositecheque"
		method="post" id="form" role="form">
	
		<input type="hidden" name="action" value="echeque" class="form-control"/>
		<div class="form-group">
		<label for="email">Echeque No.</label>
		<input type="text" name="echeque_no" class="form-control" >
		</div>
		 <input type="submit"
