...
<%! @SuppressWarnings("unchecked") %>
    <div class="container-fluid ">
      ...
      <div class="headerStyle">
        ...
        <div class="col-md-1" style="border:solid 0px"></div>
        <div class="col-md-4" style="border:solid 0px;margin:30px">
        
        
        <div class="panel-group">
  				<div class="panel panel-primary">
   				<div class="panel-heading">Create E-Cheque</div>
  			
    			<div class="panel-body">
					<form action="createecheque" method="post" id="form" role="form">
  			
			<input type="hidden" name="action" value="createecheque" >
		<div class="form-group">
		Echeque Number
		: <input type="text" class="form-control" name="echeque_no" value="<%=(String) request.getAttribute("echeque_no")%>" readonly />
		</div>
		<div class="form-group">
		 Account Number
		: <input type="text" class="form-control" name="recepient_accno" >
		 </div>
		 <div class="form-group">
		 First Name
