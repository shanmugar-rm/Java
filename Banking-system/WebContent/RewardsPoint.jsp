...
DAO dao = new DAO();
dao.DBConnect();
String account_number = session.getAttribute("acct_number").toString();
System.out.println("Accno:"+account_number);
%>

				<div class="list-group">
					<a href="#" class="list-group-item active"><strong>
							Your Transaction History</strong></a> <a href="#" class="list-group-item">
						...
						<table class="table table-striped">
							...
							<tbody>
								<tr>
									...
									<td><%= dao.getRewardsPoint(account_number) %></td>
								</tr>
				...
				<div class="well well-lg">
					<div class="list-group">
						<script type="text/javascript">
							function change() {
								document.getElementById("what_to").value = "update_notifi";
							}
						</script>
						<a href="#" class="list-group-item active"><strong>
								Suggestion(s)</strong></a>
