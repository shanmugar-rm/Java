    ...
    <div class="container-fluid ">
      ...
      <div class="headerStyle">
        ...
        <div class="row" style="margin:10px;">
            ...
            <div class="col-md-4">
            <h1>Options</h1>
            <a href="addrecipient.jsp?x=<%=rs.getInt(8) %>">Add Recipient</a><br>
            <a href="tranfertoexisting.jsp?x=<%=rs.getInt(8) %>">Transfer to existing recipient</a><br>
            
            <a href="fundtransfer.jsp?x=<%=rs.getInt(8) %>">Transfer to another</a><br>
            <a href="viewrecipient.jsp?x=<%=rs.getInt(8) %>">View Recipient</a><br>
            <a href="viewtransactionhistory.jsp?x=<%=rs.getInt(8) %>">Transaction History</a><br>
