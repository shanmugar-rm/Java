...
<body>
    <div class="container-fluid ">
      ...
      <div class="headerStyle">
       ...
       <div class="col-md-5">
         <div class="panel panel-primary" style="text-align:center;" id="div1">
            
            <div class="panel-heading"><strong>OTP Verification</strong></div>
			<div class="panel-body">
		 
		<form role="form" action="otppasswordreset" method="post" id="form1">
 			 <div class="form-group">
 			 	<label for="email">Email address:</label>
		     	<input type="text" name="email" class="form-control">
		     </div>
		     <div class="form-group">
		     <label for="Login">Enter Login ID:</label>
		     <input type="text" name="username" class="form-control"/><br>
		     <input type="hidden" name="action" value="otpgenerate" />
		     </div>
        <button type="submit" class="btn btn-default" id="otpclick">Send OTP</button>
		</form></div>
		<h2><%= request.getAttribute("Message1") %></h2>
		 </div>
		</div>
		...
		<form role="form" action="otppasswordreset" method="post" id="form2">
 			 <div class="form-group">
