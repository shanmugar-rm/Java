		...
		<div class="row" style="margin: 10px;">
          ...
          <li class="active"><a href="echeque.jsp?x=<%=session.getAttribute("acct_number").toString()%>">Echeque</a></li>
           ...
           <li class="active"><a href="Contact.jsp?x=<%=session.getAttribute("acct_number").toString()%>">Contact Us</a></li>
			...
			<div class="col-md-4">
				<form action="addrecipient" method="post" name="f1"
					onsubmit="return checkdata()">
					<input type="hidden" name="id"
						value="<%=session.getAttribute("acct_number").toString()%>">
					<h1>
						<p>${message}</p>
					</h1>
					<div class="panel panel-default">
						...
						<div class="panel-body" style="text-align: center">
							...
							<div class="form-group" style="text-align: left">
								<label for="name" style="text-align: left">Account
									Number:</label> <input type="text" class="form-control" name="accno"
									maxlength="10">
							</div>

							<div class="form-group" style="text-align: left">
								<label for="pwd" style="text-align: left">Firstname:</label> <input
									type="text" class="form-control" name="firstname">
							</div>

							<div class="form-group" style="text-align: left">
								<label for="pwd" style="text-align: left">Lastname:</label> <input
									type="text" class="form-control" name="lastname">
							</div>

							<div class="form-group" style="text-align: left">
								<label for="pwd" style="text-align: left">Nickname:</label> <input
