      ...
      <div class="headerStyle">
        ...
        <div class="panel-group">
  				<div class="panel panel-primary" style="text-align:center">
   				<div class="panel-heading"><strong>Confirmation for E-Cheque</strong></div>
  			
    			<div class="panel-body">
    			<form role="form">
    			
    			<div class="form-group">
					<label for="email">Echeque Number:</label>
					<%=(String) request.getAttribute("echeque_no")%>
					</div>
		 <div class="form-group">
		 <label for="email">Account Number:</label>
		<%=(String) request.getAttribute("recepient_accno")%> 
		</div>
		 <div class="form-group">
