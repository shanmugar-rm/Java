...
<body>
    ...
    <div class="container-fluid ">		        
        <div class="row" style="margin:10px;">        
            ...
            <div class="col-md-6">
		<form action="FacultyMainServlet?x=EditCourse" method="post" name="f1" enctype="multipart/form-data">
		<h1><p>${message}</p></h1>
                  ...
                  <div class="panel-heading" style="text-align:center;"><h4>Edit Course Information</h4></div>
                   ...
                   <div class="panel-body" style="text-align:center" >
                    ...
                    <label for="email_id" style="text-align:left">Email ID:</label>
               		<input type="text" class="form-control" name="email_id" maxlength="45" value="<%=faculty_course.get(i).getEmail_id()%>">
            		</div>            		
